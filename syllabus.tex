...
Two caveats: no ``live'' communications with other people are allowed,
...
\textbf{Attendance:} \\
Attendance is calculated as 50 points. One point is subtracted for each
unexcused absence, including absences from Study Sessions.
